		...
		<div class="farmers-container">
			<div class="farmers-grid" id="cardView">
				@foreach($farmers as $farmer)
					<div class="farmer-card" data-id="{{ $farmer->id }}" data-name="{{ strtolower($farmer->name) }}"
						data-nic="{{ strtolower($farmer->nic_no) }}" data-phone="{{ $farmer->primary_mobile }}"
						data-district="{{ $farmer->district }}" data-status="{{ $farmer->is_active ? 'active' : 'inactive' }}"
							...
							<div class="profile-section">
								<div class="profile-img">
									<img src="{{ asset('uploads/profile_pictures/' . ($farmer->user->profile_photo ?? 'default-avatar.png')) }}"
										alt="{{ $farmer->name }}" onerror="this.src='{{ asset('assets/images/farmer.png') }}'">
								</div>
			...
			<div class="farmers-table-container" id="tableView" style="display: none;">
				<div class="table-responsive">
					<table class="farmers-table">
						...
						<tbody>
							@foreach($farmers as $farmer)
								<tr class="farmer-row" data-id="{{ $farmer->id }}" data-name="{{ strtolower($farmer->name) }}"
									data-nic="{{ strtolower($farmer->nic_no) }}" data-phone="{{ $farmer->primary_mobile }}"
									...
									<td>
										<div class="table-actions">
											<button class="btn-icon btn-view" onclick="viewFarmer({{ $farmer->id }})"
												title="View">
												<i class="fas fa-eye"></i>
											</button>
											<a href="{{ route('lf.editFarmer', $farmer->id) }}" class="btn-icon btn-edit"
												title="Edit">
												<i class="fas fa-edit"></i>
											</a>
											<button class="btn-icon btn-delete"
												onclick="deleteFarmer({{ $farmer->id }}, '{{ $farmer->name }}')" title="Delete">
