...
<div class="manage-farmers-container">
    <div class="header-section">
        <div class="header-left">
            ...
            <p class="subtitle">
                Total: <span class="badge-count">{{ $farmers->count() }}</span> farmers
            </p>
        </div>
        <div class="header-right">
            <a href="{{ route('lf.registerFarmer') }}" class="btn btn-add">
    ...
    <div class="filters-section">
        <div class="search-container">
            <div class="search-box">
                ...
                <input type="text" id="searchInput" placeholder="Search farmers by name, NIC, or phone...">
    ...
    <div class="farmers-container">
        <div class="farmers-grid" id="cardView" style="display: block;">
                ...
                <div class="card-header">
                    <div class="profile-section">
                        ...
                        <div class="profile-info">
                            ...
                            <p class="farmer-username">
                                <i class="fas fa-at"></i> {{ $farmer->user->username ?? 'N/A' }}
                            </p>
                        </div>
                    </div>
                ...
                <table class="farmers-table">
                    ...
                    <tbody>
                        ...
                        <tr class="farmer-row" data-id="{{ $farmer->id }}" 
                            ...
                            <td>
                                <span class="payment-badge {{ $farmer->preferred_payment }}">
                                    @if($farmer->preferred_payment == 'bank')
                                        <i class="fas fa-university"></i> Bank
                                    @elseif($farmer->preferred_payment == 'ezcash')
                                        <i class="fas fa-mobile-alt"></i> EzCash
                                    @elseif($farmer->preferred_payment == 'mcash')
                                        <i class="fas fa-mobile-alt"></i> mCash
                                    @elseif($farmer->preferred_payment == 'all')
                                        <i class="fas fa-wallet"></i> All
                                    @endif
                                </span>
                            </td>
                            <td>
...
function showFarmerDetails(farmer) {
    ...
    if (farmer.preferred_payment === 'bank') {
        ...
        paymentDetailsHtml = `
            <div class="detail-section">
                <h4><i class="fas fa-wallet"></i> Payment Details (All Methods)</h4>
                <div class="detail-row">
                    <span>Bank Name:</span>
                    <span>${farmer.bank_name || 'N/A'}</span>
                </div>
        ...
        html: `
            <div style="text-align: left;">
                ...
                <ul class="text-warning">
                    <li>Set farmer status to "Inactive"</li>
                    <li>Update product status to "removed by lead farmer"</li>
                    <li>Farmer data will be preserved in the system</li>
                </ul>
            </div>
        `,
        icon: 'warning',
