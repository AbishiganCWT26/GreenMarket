                ...
                <div class="compact-card photo-section">
                    ...
                    <div class="card-content">
                        ...
                        <div class="photo-actions">
                            <button class="compact-btn photo-btn"
                                onclick="window.location.href='{{ route('lf.profile.photo') }}'">
                                ...
                                <div class="form-grid">
                                    ...
                                    <div class="form-group compact">
                                        ...
                                        <input type="text" name="nic_no"
                                            class="form-input @error('nic_no') error-input @enderror"
                                ...
                                <div class="form-grid">
                                    <div class="form-group compact">
                                        ...
                                        <input type="text" name="primary_mobile"
                                            class="form-input @error('primary_mobile') error-input @enderror"
                                    ...
                                    <div class="form-group compact">
                                        ...
                                        <input type="text" name="whatsapp_number"
                                            class="form-input @error('whatsapp_number') error-input @enderror"
                                ...
                                <div class="form-grid">
                                    <div class="form-group compact full-width">
                                        ...
                                        <textarea name="residential_address"
                                            class="form-input textarea-input @error('residential_address') error-input @enderror"
                                            rows="2"
                                    ...
                                    <div class="form-group compact full-width">
                                        ...
                                        <select name="district" class="form-input @error('district') error-input @enderror"
                                            required>
                                    ...
                                    <div class="form-group compact full-width">
                                        ...
                                        <input type="text" name="grama_niladhari_division"
                                            class="form-input @error('grama_niladhari_division') error-input @enderror"
                                ...
                                <div class="form-grid">
                                    <div class="form-group compact">
                                        ...
                                        <input type="text" name="account_holder_name"
                                            class="form-input @error('account_holder_name') error-input @enderror"
                                    ...
                                    <div class="form-group compact">
                                        ...
                                        <input type="text" name="ezcash_mobile" id="ezcash_mobile" class="form-input"
                                            value="{{ old('ezcash_mobile', $leadFarmer->ezcash_mobile) }}"
                                            placeholder="074/076/077...">
                                        <div id="ezcash_error"
                                            style="color: #ef4444; font-size: 0.75rem; margin-top: 4px; display: none;">Must
                                            start with 074, 076, or 077</div>
                                    </div>
                                    <div class="form-group compact">
                                        <label><i class="fas fa-mobile-alt"></i>mCash Number</label>
                                        <input type="text" name="mcash_mobile" id="mcash_mobile" class="form-input"
                                            value="{{ old('mcash_mobile', $leadFarmer->mcash_mobile) }}"
                                            placeholder="070/071...">
                                        <div id="mcash_error"
                                            style="color: #ef4444; font-size: 0.75rem; margin-top: 4px; display: none;">Must
                                            start with 070 or 071</div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-body">
                <form id="changePasswordForm" class="compact-form">
                    ...
                    <div class="form-group compact">
                        ...
                        <div class="requirements mt-3">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li id="rule-length" class="text-danger"><i class="fas fa-times me-1"></i> 8+ characters
                                </li>
                                ...
                                <li id="rule-special" class="text-danger"><i class="fas fa-times me-1"></i> Special char
                                </li>
                                <li id="rule-no-space" class="text-danger"><i class="fas fa-times me-1"></i> No spaces</li>
                                <li id="rule-no-repeat" class="text-danger"><i class="fas fa-times me-1"></i> No repeated
                                </li>
                                <li id="rule-no-sequence" class="text-danger"><i class="fas fa-times me-1"></i> No sequence
                                </li>
                                <li id="rule-not-common" class="text-danger"><i class="fas fa-times me-1"></i> Not common
                                </li>
                                <li id="rule-no-links" class="text-danger"><i class="fas fa-times me-1"></i> No links</li>
                                <li id="rule-no-personal" class="text-danger"><i class="fas fa-times me-1"></i> No Personal
                                    Info</li>
                            </ul>
                        </div>
                    </div>
                    <div class="form-group compact">
                        ...
                        <div class="password-field">
                            <input type="password" name="new_password_confirmation" class="form-input" id="confirmPassword"
                                required>
