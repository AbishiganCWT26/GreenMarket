...
<div class="main-container">
		...
		<div class="hero-content-overlay">
			<div class="hero-text">
					...
					@if(auth()->check())
						@php
							...
							switch($user->role) {
								...
								case 'facilitator': $dashboardUrl = '/facilitator/dashboard'; break;
								case 'lead_farmer': $dashboardUrl = '/lead-farmer/dashboard'; break;
								case 'farmer': $dashboardUrl = '/farmer/dashboard'; break;
								case 'buyer': $dashboardUrl = '/buyer/dashboard'; break;
							}
						@endphp
				...
				<div class="hero-features">
					<div class="feature">
						<img src="{{ asset('assets/icons/Fair price-yellow.png') }}" alt="Fair Price Icon" width="24" height="24">
	...
	<section class="stats-section">
		...
		<div class="stats-grid">
			...
			<div class="stat-card">
				<div class="stat-icon">
					<img src="{{ asset('assets/icons/farmer-icon.svg') }}" alt="farmer Icon" width="70%" height="70%" style="filter: brightness(0) invert(1);">
				</div>
			...
			<div class="stat-card">
				<div class="stat-icon">
					<img src="{{ asset('assets/icons/buyer.svg') }}" alt="farmer Icon" width="70%" height="70%" style="filter: brightness(0) invert(1);">
				</div>
	...
	<section class="services-section">
		<div class="section-header">
			...
			<p class="section-subtitle">Everything you need for fresh produce</p>
		</div>
		<div class="services-grid">
			<div class="service-card">
				...
				<p class="service-desc">Pay after collection</p>
			</div>
			<div class="service-card">
				<div class="service-icon">
				...
				<p class="service-desc">100% Safe</p>
			</div>
			<div class="service-card">
				<div class="service-icon">
				...
				<p class="service-desc">Call and order</p>
			</div>
			<div class="service-card">
				<div class="service-icon">
				...
				<p class="service-desc">Best prices guaranteed</p>
			</div>
			<div class="service-card">
				<div class="service-icon">
				...
				<p class="service-desc">Natural & chemical-free</p>
			</div>
			<div class="service-card">
				<div class="service-icon">
				...
				<p class="service-desc">Buyer Arranges Transport</p>
			</div>
		</div>
	</section>
		...
		<div class="categories-grid">
			...
			<div class="category-card">
				<div class="category-icon">
					...
					@endphp
					<img src="{{ asset('assets/images/taxonomy-icons/' . $icon) }}" alt="{{ $category->category_name }}">
				</div>
				<div class="category-content">
					<h3>{{ $category->category_name }}</h3>
					<p>{{ $category->description ?? 'Fresh organic products' }}</p>
					<span class="category-badge">{{ $category->product_count }} Products</span>
				</div>
			</div>
			@endforeach
		</div>
