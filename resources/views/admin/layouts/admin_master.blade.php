...
<body>
            ...
            <nav class="sidebar-nav">
                <ul class="main-menu">
                    ...
                    <li><a href="{{ url('/admin/users') }}"
                            class="menu-link {{ request()->is('admin/users*') ? 'active' : '' }}"><i
                                class="fa-solid fa-users-gear"></i><span>User Management</span></a></li>
                    <li><a href="{{ url('/admin/products') }}"
                            class="menu-link {{ request()->is('admin/products*') ? 'active' : '' }}"><i
                                class="fa-solid fa-box-open"></i><span>Product Oversight</span></a></li>
                    <li><a href="{{ route('admin.inventory.index') }}"
                            class="menu-link {{ request()->routeIs('admin.inventory.index') ? 'active' : '' }}"><i
                                class="fa-solid fa-chart-line"></i><span>Inventory Oversight</span></a></li>
                    <li><a href="{{ url('/admin/sales') }}"
                            class="menu-link {{ request()->is('admin/sales*') ? 'active' : '' }}"><i
                                class="fa-solid fa-receipt"></i><span>Sales</span></a></li>
                    <li><a href="{{ url('/admin/complaints') }}"
                            class="menu-link {{ request()->is('admin/complaints*') ? 'active' : '' }}"><i
                                class="fa-solid fa-flag"></i><span>Users Complaints</span></a></li>
                    <li><a href="{{ url('/admin/lead-farmer-groups') }}"
                            class="menu-link {{ request()->is('admin/lead-farmer-groups*') ? 'active' : '' }}"><i
                                class="fa-solid fa-users-between-lines"></i><span>Lead Farmer Groups</span></a></li>
                    ...
                    <li><a href="{{ url('/admin/taxonomy') }}"
                            class="menu-link {{ request()->is('admin/taxonomy*') ? 'active' : '' }}"><i
                                class="fa-solid fa-seedling"></i><span>Product Category</span></a></li>
                    <li><a href="{{ url('/admin/standards') }}"
                            class="menu-link {{ request()->is('admin/standards*') ? 'active' : '' }}"><i
                                class="fa-solid fa-ruler-combined"></i><span>Product Standards</span></a></li>

                    <li class="menu-heading">REPORTS</li>

                    <li><a href="{{ url('/admin/reports') }}"
                            class="menu-link {{ request()->is('admin/reports*') ? 'active' : '' }}"><i
                                class="fa-solid fa-chart-bar"></i><span>Reports</span></a></li>

                    <li class="menu-heading">CONFIG</li>

                    <li><a href="{{ url('/admin/config') }}"
                            class="menu-link {{ request()->is('admin/config*') ? 'active' : '' }}"><i
                                class="fa-solid fa-gear"></i><span>Configuration</span></a></li>

                    <li class="menu-heading">PROFILE</li>

                    <li><a href="{{ url('/admin/profile') }}"
                            class="menu-link {{ request()->is('admin/profile*') ? 'active' : '' }}"><i
                                class="fa-solid fa-user"></i><span>My Profile</span></a></li>
                    <li><a href="{{ url('/admin/profile/photo') }}"
                            class="menu-link {{ request()->is('admin/profile/photo*') ? 'active' : '' }}"><i
                                class="fa-solid fa-camera"></i><span>Profile Photo</span></a></li>
                    <li><a href="{{ url('/admin/notifications') }}"
                            class="menu-link {{ request()->is('admin/notifications*') ? 'active' : '' }}"><i
                                class="fa-solid fa-bell"></i><span>Notification</span></a></li>
                </ul>
            </nav>
            ...
            <header class="navbar">
                ...
                <div class="header-right-group">
                                        ...
                                        <div class="notif-item {{ $n->is_read ? 'read' : 'unread' }}" data-id="{{ $n->id }}">
                                            ...
                                            <div class="notif-content">
                                                ...
                                                <div class="notif-time">
                                                    {{ \Carbon\Carbon::parse($n->created_at)->diffForHumans() }}</div>
                                            </div>
                    ...
                    <div class="header-user-meta">
                        ...
                        <span
                            class="username">{{ Auth::user()->username ?? Auth::user()->name ?? 'Administrator' }}</span>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            @if($errors->any())
                Swal.fire({
                    @if(file_exists(public_path('assets/icons/Validation Error.png'))) imageUrl: '{{ asset('assets/icons/Validation Error.png') }}', imageWidth: 60, imageHeight: 60 @else icon: 'error' @endif,
