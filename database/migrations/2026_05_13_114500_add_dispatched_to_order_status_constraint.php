...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Add updated constraint including 'Dispatched'
        DB::statement("ALTER TABLE orders ADD CONSTRAINT orders_order_status_check 
            CHECK (order_status IN ('Processing order', 'confirmed', 'paid', 'ready_for_pickup', 'Dispatched', 'completed', 'cancelled', 'refunded', 'Payment Pending', 'awaiting_verification'))");
    }
